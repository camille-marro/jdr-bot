...
function startCombatPVE(player, enemyPokemon, message) {
    ...
    msgEmbed.setTitle("Vous croisez un pokémon sauvage !");
    ...
    combatPVE(player, enemyPokemon, team, combatObject, message).then(res => {
...
function combatPVE(player, enemyPokemon, playerTeam, combatObject, message) {
