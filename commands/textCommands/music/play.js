...
async function play(message) {
    ...
    log.print("tried to play this music : " + query, message.author, message.content);
    ...
    if (args[1] === "help") {
        ...
        log.print("action is impossible : no query given", 1);
    ...
    if (!message.member.voice.channel) {
        ...
        log.print("action is impossible : user not in a voice channel", 1);
    ...
    if (url._data.playlist) {
        ...
        log.print("playlist found ! playlist added to the queue", 1);
    } else {
        ...
        log.print("track found ! track added to the queue", 1);
    }
