...
async function playAudio(message, queue) {
    ...
    if (options[1] === "help") {
        ...
        if (!pattern.test(yt_link)) {
            ...
            console.log("|- " + message.author['username'] + "(#" + message.author['id'] + ") played an audio.");
        }
        ...
        if (getVoiceConnection(channel.guildId) === undefined) {
            ...
            connection = getVoiceConnection(channel.guildId);
        }// le bot se connecte qui s'il n'est pas dans un channel
